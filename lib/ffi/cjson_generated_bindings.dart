...
class CJson {
  ...
  late final _cJSON_ParseWithLengthPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<cJSON> Function(
              ffi.Pointer<ffi.Char>, ffi.Size)>>('cJSON_ParseWithLength');
  late final _cJSON_ParseWithLength = _cJSON_ParseWithLengthPtr
      .asFunction<ffi.Pointer<cJSON> Function(ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _cJSON_ParseWithLengthOpts =
      _cJSON_ParseWithLengthOptsPtr.asFunction<
          ffi.Pointer<cJSON> Function(ffi.Pointer<ffi.Char>, int,
  ...
  late final _cJSON_InsertItemInArrayPtr = _lookup<
      ffi.NativeFunction<
          cJSON_bool Function(ffi.Pointer<cJSON>, ffi.Int,
  ...
  ffi.Pointer<ffi.Char> cJSON_SetValuestring(
    ffi.Pointer<cJSON> object,
  ...
  late final _cJSON_SetValuestringPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<cJSON>,
              ffi.Pointer<ffi.Char>)>>('cJSON_SetValuestring');
...
const int CJSON_VERSION_PATCH = 17;
